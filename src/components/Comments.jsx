...
import { Alert, Avatar, Box, Button, FormControl, Input, InputLabel, Paper, Snackbar, Stack, TextField, Typography } from '@mui/material'
import {Formik, Form, Field} from 'formik'
import * as Yup from 'yup' 
import { useDispatch, useSelector } from 'react-redux'
import { blue } from '@mui/material/colors'
import { createCommDispatch } from '../actions/commentActions'
            ...
            <Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={validationSchema}>
                {(props)=>(
                    <Form >
                        ...
                        <Button type='submit' size='small' sx={{color: 'black'}}>comment</Button><Button sx={{color: 'grey'}} onClick={props.resetForm} size='small'>cancel</Button>
                        </Box>
                        </Stack>
                    </Form>
                )}
